/**
 * Team Auth Routes - Team member authentication
 */
...
router.post('/login', async (req: Request, res: Response) => {
  try {
    ...
    // Get parent user's company name to use as team display name
...
router.get('/me', async (req: Request, res: Response) => {
  try {
    ...
    // Convert permissions array to map format for frontend with action-level booleans
