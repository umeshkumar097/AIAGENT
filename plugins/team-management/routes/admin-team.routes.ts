/**
 * Admin Team Routes - Super admin's own team management for sub-admins
...
router.get('/permissions/sections', async (req: AuthRequest, res: Response) => {
  try {
...
router.get('/permissions/:roleId', async (req: AuthRequest, res: Response) => {
  try {
